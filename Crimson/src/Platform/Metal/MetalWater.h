...
namespace Crimson {
	...
	/*
		...
		For Metal impl for water, I will optionally have a refraction and reflection, or a low-res version
	...
	*/
	...
	class MetalWater : public Water
	{

	public:
		MetalWater(const glm::vec3& dims, const glm::vec4& water_color, const glm::vec2& screen_size);
		~MetalWater() = default;
