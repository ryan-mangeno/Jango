...
namespace Crimson {
	...
	void Renderer2D::Init()
	{
		...
		m_data->Lineshader = (Shader::Create("Crimson_Editor/Assets/Shaders/{API}/Line{EXT}"));
		m_data->shader = (Shader::Create("Crimson_Editor/Assets/Shaders/{API}/Composite2D{EXT}"));//texture shader
...
// 		}
// 
// 		s_Storage.TextureShader = Shader::Create("assets/shaders/texture{EXT}");
// 		s_Storage.LineShader    = Shader::Create("Crimson_Editor/Assets/Shaders/{API}/Line{EXT}");
// 
